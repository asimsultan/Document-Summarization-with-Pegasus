...
def main(data_path):
    ...
    train_texts, val_texts, train_labels, val_labels = train_test_split(dataset['text'], dataset['summary'], test_size=0.1)
    ...
    # DataLoader
    train_dataset = SummarizationDataset(train_encodings, train_labels.tolist())
    val_dataset = SummarizationDataset(val_encodings, val_labels.tolist())
